...
export default () => {
  ...
  const contents = [
    ...
    `이전 직장에서 금융권의 Frontend / Backend 개발을 담당했고,
    현재는 글로벌 서비스 플랫폼의 Frontend / Publishing 을 담당하고 있습니다.`,
    `Vue.js, React.js 등의 다양한 프레임워크와 라이브러리를 사용한 프로젝트 경험 뿐만 아니라,
    라이브러리 없이 Vanila Javascript 만으로 프로젝트를 진행한 경험도 있습니다.`,
    ...
    자료구조, 알고리즘, 컴퓨터 구조 등 프로그래밍의 기본 이론을 틈틈히 공부하고 있습니다.`,
    `부족한 점에 대해 항상 인지하고 보완하고자
    노력하는 개발자입니다.`,
  ];
